...
export default function SubmitButton({
	...
	return (
		<button
			...
			disabled={isLocked}
			aria-busy={pending}
			className="g2 g2-focus-ring w-full sm:w-auto min-w-40 rounded-full px-5 py-2.5 text-sm font-semibold inline-flex items-center justify-center gap-2 transition-[transform,opacity,box-shadow] cursor-pointer disabled:cursor-not-allowed disabled:opacity-45"
			style={{
				opacity,
